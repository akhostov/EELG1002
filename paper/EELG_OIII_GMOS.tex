...
%% the \begin{document} command.
	...
	%% manuscript itself with \begin{document}.
		...
		\begin{document}
			...
			\title{EELG1002: The Case of a Record-Breaking \oiii+\hbeta~EW $\sim3700$\AA~Galaxy at $z \sim 0.8$ -- Analog of Early Galaxies?}
		...
		\begin{abstract}
		Extreme emission line galaxies (EELGs) are powerful and rare low-$z$ analogs of high-$z$ galaxies that can provide us with valuable insights on the conditions expected to be present in the early Universe. We present a detailed analysis of EELG1002: a $z = 0.8275$ extreme emission line galaxy identified within 7 year old archival Gemini/GMOS data as part of ongoing work on the COSMOS Spectroscopic Archive. Using a combination of GMOS spectra and multi-wavelength photometry, we find EELG1002 is a low-mass ($10^{7 - 8}$ \msol), compact ($\sim 530$ pc), bursty star-forming galaxy with mass doubling timescales of $\sim 5 - 15$ Myr and record-breaking rest-frame \oiii+\hbeta~EW of $\sim 2800 - 3700$\AA~which is $\sim 16 - 35 \times$ higher than typical \oiii~emitters of comparable stellar mass at $z \sim 0.8$ and even higher than typical $z > 5$ galaxies. We find no clear evidence of an AGN component such that the emission line features are driven by star formation activity. EELG1002 is chemically unevolved ($12+\log_{10} (\textrm{O/H}) \sim 7.5$ consistent with $z > 5$ galaxies at fixed stellar mass) and may be undergoing a first bursty phase of star formation activity analogous to what is expected of galaxies in the early Universe. We find evidence for a highly energetic ISM (\oiii/\oii~$\sim 11$) and a hard ionizing radiation field (elevated \neiii/\oii~at fixed \oiii/\oii). Coupled with the compact, metal-poor, and actively star-forming nature, EELG1002 is found to efficiently produce ionizing photons with $\textrm{\xiion} \sim 10^{25.70 - 25.75}$ erg$^{-1}$ Hz and may have $\sim 10 - 20\%$ LyC escape fraction raising the possibility of such sources being important reionization-era analogs. The dynamical mass is found to be $\sim 10^9$ \msol~which would suggest that copious amounts of gas are present to support the intense star-formation activity. This is also confirmed in Illustris-TNG analogs of EELG1002 which have high gas masses to support star formation and show rapid chemical enrichment and stellar mass build-up during the onset of star formation activity. EELG1002 may be an ideal low-$z$ laboratory of conditions expected of galaxies in the early Universe and demonstrates how archival datasets may yield interesting sources that can support science pursued in the high-$z$ Universe as well as with next-generation surveys planned with \textit{Euclid} and \textit{Roman}.

		
		
		%Photoionization modeling within \cigale~and \bagpipes~SED fitting along with \oiii/\oii~suggest a highly energetic ISM while elevated \neiii/\oii~at fixed \oiii/\oii~show evidence of harder ionizing radiation field. Coupled with the compact, metal-poor, and actively star-forming nature, EELG1002 is found to efficiently produce ionizing photons with $\textrm{\xiion} \sim 10^{25.70 - 25.75}$ erg$^{-1}$ Hz and may have $\sim 10 - 20\%$ LyC escape fraction. EELG1002-like sources in Illustris-TNG provide supporting evidence that such galaxies a first burst of star-formation activity conform to current models of galaxy formation and evolution at $z \sim 0.8$ and are supported by high gas masses. We find dynamical mass of $\sim 10^9$ \msol~for EELG1002 suggesting that copious amounts of gas exist to support an intense period of star formation.
...
%
%		Understanding how high-$z$ galaxies formed and evolved is of utmost importance to developing our larger framework of galaxy formation \& evolution as well as on how cosmic reionization occurred and what types of sources contributed to this last cosmic phase transition. Although \textit{JWST} has provided a much needed expansion in the observable redshift window targeting galaxies well within the double digit redshifts (\zzz), local analogs of high-$z$ galaxies such as Extreme Emission Line Galaxies (EELGs) can still provide valuable insights with unprecedented spatial and spectral detail on the conditions of galaxies in the early Universe.
%		
%		Extreme emission line galaxies are known for having high equivalent widths (EWs -- ratio of emission line--to--continuum flux density) that are `extreme' in the low-$z$ Universe but are ubiquitous/typical of galaxies at high-$z$ (e.g., \zzz). The EWs of EELGs are as such that their nebular emission lines can dominate the overall photometry in the widest broadband filters. For example, `Green Peas' are one class of $z \sim 0.2 - 0.3$ EELGs identified by \oiii+\hbeta~emission dominating SDSS $r$ photometry \citep{Cardamone2009} and `Blueberries' are $z < 0.1$ EELGs identified for strong nebular contribution in SDSS $g$ \citep{Yang2017_BB}. 
%		
%		EELGs typically are low-mass ($< 10^{7 - 8}$ \msol) systems with compact sizes (\zzz) that are comparable to typical $z > 3$ galaxies (e.g., \zzz). Strong nebular features (e.g., \oiii, \hbeta, \halpha) confirm recent and intense star-formation activity with mass doubling timescales $< 100$ Myr (\zzz). Recent non-parametric star formation history modeling also find that EELGs not only go through a recent, intense burst of star-formation but may have also gone through past bursts highlighting episodic SFHs (\zzz; Tang+2022). \cite{Cohn2018} suggests that high EW systems at high-$z$ represent galaxies undergoing a first bursty phase of star-formation activity given that stellar mass buildup has not fully taken effect (fainter continuum flux densities) resulting in higher \oiii+\hbeta~EW. After each subsequent burst, the stellar continuum increases in brightness resulting in lower EWs. Hydrodynamical simulations also suggest that star formation activity in high-$z$ galaxies is burst-dominated (\zzz; Sparre, Faucher+18). Identifying high EW EELGs in the low-$z$ Universe then provides an interesting window in studying the star formation processes expected to occur in the high-$z$ Universe. Given that EELGs are also low in gas-phase metallicity also suggests chemical enrichment levels consistent with galaxies in the high-$z$ Universe and potential of chemically unevolved systems undergoing a first phase of bursty star-formation (\zzz). 
%		
%		The compact, star-forming nature of EELGs also make such sources analogs of sources that could potentially drive cosmic reionization in the high-$z$ Universe.
		
		


Understanding how star-formation occurred in the early Universe is crucial in our understanding of how galaxy formation and cosmic Reionization occurred. Prior to \textit{JWST}, it was very difficult to observe galaxies at $z > 6$ and was primarily limited to samples selected as Lyman Break Galaxies (LBGs; e.g., \citealt{Bouwens2011,McLure2013,Oesch2014,McLeod2016,Ishigaki2018,Finkelstein2022}), \lya~emitters (e.g., \citealt{Rhoads2000,Malhotra2004,Dawson2007,Matthee2014,Santos2016,Konno2018,Sobral2018,Taylor2020,Goto2021,Wold2022,Torralba2024}), and galaxies selecting based on nebular excess within the \textit{Spitzer}/IRAC bands (e.g., \citealt{Shim2011,Smit2015,Faisst2016_EW,Marmol2016,Rasappu2016,deBarros2019,Lam2019,Endsley2021_EW}). However, in only the first few years of \textit{JWST} we are detecting numerous $z > 6$ galaxies that were missed in past selection techniques and also galaxies with redshifts in the double digits. \textit{JWST} has pushed our observable window further towards the era that we expect harbors the first generation of galaxies. However, local analogs of high-$z$ galaxies can still provide us with valuable insight on the conditions of galaxies in the early Universe that are still limiting with even \textit{JWST}. % are learning a great deal more about the early Universe as numerous $z > 6$ galaxies are being observed both photometrically and spectroscopically
...
%		paragraph 1:
%			start by talking about how studying early galaxies is crucial in our understanding on how galaxy formation occurred, in what fashion star formation happened, and how did it contribute in Cosmic Reionization. 
%			
%		paragraph 2: Mention how pre-\textit{JWST} it was difficult to observe such sources. Now with \textit{JWST} we are finding galaxies well into double digit redshifts and it is challenging our understanding of reionization and galaxy formation. Mention the cosmic reionization budget crisis (Intae's paper) and massive galaxies in high-$z$ Universe (e.g., Ivo?) and SMBHs being more than expected Rebecca \& Erini. 
%		
%		However, as we push to higher redshift, we fall into the same situation we were in pre-\textit{JWST} for the $z > 6$ Universe (lacking rest-frame IR observations).  Now mention pre-\textit{JWST} studies focused on using analogs of high-$z$ galaxies identified at low-$z$. 
%		
%		Here we start by introducing EELGs, GPs, BBs, and LyC leakers. Mention how they have similar properties to high-$z$ galaxies and have been used also for calibration purposes (the Perez-Montero EELG papers?). They have also been investigated for LyC escape to develop calibrations that could be applied to the high-$z$ Universe where IGM transmission makes it practically impossible to measure fesc (Chisholm, Choustikov). It also has been used to study LyC mechanisms as well as AGN variability (Santosh) which does become important given the importance of AGNs we are finding with \textit{JWST}.
%		
%		Now say that EELGs at low-$z$ can still be used for doing high-$z$ science via the low-$z$ Universe. Then mention in this paper we identified a source within ongoing work of the COSMOS Spectroscopic archive that has record-breaking EW at $z \sim 0.8$ and is also highly reminiscent to typical and extreme ELGs observed with JWST. In this work we investigate this source in great detail using a combination of GMOS spectra, detailed spectrophotometric SED fitting, morphology measurements, and analogs in Illustris-TNG. The main objective of this paper is to first highlight the importance of such a source and motivate further search of EELG1002-like systems to develop larger statistical samples for analysis. Second, demonstrate the power of archival data in providing valuable insight on what is potentially happening in the high-$z$ Universe and galaxy formation \& evolution in general.
%		
%		Now Mention the structure of the paper.
%		
%		Now mention the assumptions.
	
		\section{Data}
		\label{sec:data}
		
		The COSMOS Spectroscopic Archive {\color{red} Khostovan et al., in prep \zzz} is a large effort of gathering and processing all ground-based spectroscopic observations done over the past two decades with the COSMOS legacy field \citep{Scoville2007}. As part of our search, we came across EELG1002 within the Gemini Science Archive which was part of a Fast Turnaround program, GS-2017A-FT-9 (PI: Kiyoto Yabe). The main focus of the program was to target emission line galaxies at $z > 0.3$ that were identified by strong nebular excess within the Subaru/HSC broadband filters indicative of high EW emission lines. These sources are expected to have strong \oiii~EW of $>2000$\AA~and are metal-poor with the possibility of \oiii4363\AA~detection. 
		...
		Ancillary \textit{HST}/WFC3 F140W imaging of EELG1002 was also found as part of a search through the MAST portal. The associated program, PID \#15115 (PI: John Silverman; \citealt{Silverman2018,Ding2020}), targeted a sample of $z \sim 1.5$ broad-line AGN to study supermassive black hole properties and how it relates to galaxy mass. One of their main targets, LID360, happened to be oriented as such that EELG1002 fell within the \textit{HST} FoV with a total on-source exposure time of $\sim 2400$ seconds. Post-processing and photometry measurements were done as part of the Hubble Advance Program (HAP) Single Visit Mosaics (SVM) program (\zzz~CITATION?). EELG1002 is found to have a F140W magnitude of $23.89\pm0.08$ mag within a $2''$ aperture (large enough to encompass the full source; see Figure \ref{fig:slitpos}).
		...
		The second step in the pipeline is to 2D coadd all 3 reduced science frames of varying central wavelengths (accounts for GMOS chip gaps in final 2D coadded spectra). To account for potential drift during observations, we define the offsets by using the brightest object in the mask (\zzz~mention which object?). \pypeit~then models the spatial profile of the object and calculates the spatial shift in reference to the first science frame in our 2D coadd list. This is then stacked with weights corresponding to the S/N of our brightest object. Objects are then extracted using the \cite{Horne1986} optimal extraction algorithm.
	
	
	
		\subsubsection{Flux Calibration \& Slit Loss Corrections}
		
		Flux calibration is done by first reducing our standard star LTT7379 (G0) using the same \pypeit~reduction as mentioned above. We then use the wavelength-calibrated, reduced spectra to measure the sensitivity curve that converts raw counts into physical flux units. \pypeit~does this by comparing the observed 1D GMOS spectra against archival spectra drawn, in this case, from ESO Optical and UV Spectrophotometric Standard Stars library. The final sensitivity curve is then applied to each of our science targets. Atmospheric extinction corrections are applied to both the standard star used in generating the sensitivity curve as well as the science target spectra taking into account varying airmass at time of observation. This is all included in the \pypeit~scripts that make the sensitivity curve and applies the flux calibration. This is done by using the observatory's extinction file (in our case La Silla) and applies the extinction curve as a function of wavelength and airmass associated with the spectra being corrected.
		...
		We measure the electron density, $n_e$, using the \oii3726,3729\AA~doublet which is sensitive to $T_e$ (e.g., can vary from $\sim 500$ cm$^{-3}$ to $\sim 640$ cm$^{-3}$ by increasing $T_e$ from 10000 K to 20000 K assuming \oii~doublet ratio is of order unity.) Therefore, we first measure the electron temperature as described above and then measure $n_e$ using \texttt{getTemDen} function with  $T_e(\rm{O}^{+})$ and observed \oii3729/\oii3726\AA~ratio.
		...
		\begin{equation}
			...
			\label{eqn:logU}
		\end{equation}
		where $Q_H$ is the number of hydrogen ionizing photons per unit time, $R_S$ is the Str\"{o}mgen radius, $c$ is the speed of light, and $n_H$ is the hydrogen number density. Essentially, $U$ traces how many ionizing photons are produced within an H{\sc ii} region in comparison to the present number of hydrogen atoms. Higher ionization parameter would signify more ionizing photons and/or less hydrogen atoms that can be interpreted as energetic ISM conditions.% caused by: harder ionizing radiation field (\zzz), electron density (\zzz), higher SFR (\zzz), lower metallicities 
		
		O32 is a classical indicator of $U$ as O$^{++}$ requires 35 eV compared to O$^{+}$ which requires 13.6 eV such that it is sensitive to the ionization state of gas within H{\sc ii} region. An alternative is the Ne3O2 ratio where Ne$^{++}$ requires $\sim 41$ eV and is insensitive to dust attenuation \citep{Levesque2014}. Coupling of both can also provide insight as to the shape (hardness) of the ionizing spectrum given Ne$^{++}$ has ionization potential $\sim 6$ eV higher that O$^{++}$ (e.g., \citealt{Strom2017,Jeong2020}). Using both diagnostics to directly measure $U$ is limited based on the gas-phase metallicity range used in calibrating the diagnostic \citep{Kewley2019}. As such, we measure $U$ via photoionization modeling included in \texttt{HCM} \citep{PerezMontero2014}, \texttt{Bagpipes} \citep{Carnall2018}, and \texttt{Cigale} \citep{Boquien2019}.
			
		\texttt{HII-CHI-mistry} \texttt{(HCM) v5.3}\footnote{\href{https://github.com/Estallidos/HII-CHI-Mistry}{https://github.com/Estallidos/HII-CHI-Mistry}} \citep{PerezMontero2014} is a publicly available python package that uses a grid of models to measure chemical abundances and ionization parameters of inputted emission line fluxes. It generates the model grid using \texttt{Cloudy v17} \citep{Ferland2017} with fixed $n_e = 100$ cm$^{-3}$ to model the nebular gas and \texttt{BPASS v2.1} \citep{Eldridge2017} to model the stellar continuum arising from binary stellar populations assuming an instantaneous star burst within a 1 Myr timescale and a broken power-law IMF with slope $-1.35$ and upper mass cutoff of $300$ \msol. The combination of both forms a grid of modeled line ratios (e.g., \oiii/\oii) as a function of O/H, N/O, and $U$. The observed line fluxes and ratio are then compared to the modeled grid and used to measure the best-fit gas-phase abundances and $U$. We also measure $U$ from spectrophotometric SED fitting (simultaneous fitting of the GMOS spectra and multi-wavelength photometry) using \texttt{Cigale} and \texttt{Bagpipes} for which we refer the reader to \S\ref{sec:SED} for more details.
	
		\subsection{Spectral Energy Distribution Fitting}
		\label{sec:SED}
		
		In this section, we describe our SED fitting parameters and assumptions used in both \texttt{Cigale} and \texttt{Bagpipes} where we simultaneously fit both the GMOS spectra and ancillary multi-wavelength photometry (see \S\ref{sec:data}). Although \textit{GALEX}/FUV and NUV photometry do exist or EELG1002, we chose to disregard it in the SED fitting process given the low spatial resolution as shown in Figure \ref{fig:slitpos} where blending with 2 nearby sources is an issue. The same is true for \textit{Spitzer}/IRAC photometry. Lastly, all photometry used in the SED fitting process have an additional 10\% uncertainity included in quadrature to account for underestimated errors. Setup files are also made available within the \texttt{GitHub} repository \footnote{HTML LINK \zzz}. 
		
		
		\subsubsection{{\sc Cigale}}
		\label{sec:cigale}
				
		We use \texttt{Cigale v2022.1} \citep{Boquien2019,Yang2022}, a template grid-based SED fitting code, and provide a brief overview of assumptions made in the SED fitting process which are highlighted in Table \ref{table:cigale}. Both photometry and line fluxes measured from the GMOS spectra are included in the SED fitting process. Briefly, we assume a \cite{Bruzual2003} stellar population synthesis model coupled with a \cite{Chabrier2003} IMF and consider stellar metallicities within the range of 0.005 and 1 $Z_\odot$. Nebular emission is modeled using the \cite{Inoue2011} templates which were generated using \texttt{Cloudy v13.01} \citep{Ferland2013} with $U$ considered in the range of $-3.0$ to $-1.0$. Gas-phase metallicity is fixed to 0.001 (closest to our best metallicity measurement; Table \ref{table:ISM}). \texttt{Cigale} only allows for three different fixed values for $n_e$ for which we assume $100$ and $1000$ cm$^{-3}$ given our measured $n_e$ falls in between this range (see Table \ref{table:ISM}and \S\ref{sec:ne_and_te}). Both $f_{esc} $ (LyC escape fraction) and $f_{dust}$ (fraction of LyC photons absorbed by dust) are fixed to $0$\% in the nebular emission modeling; however, we do note that there is the possibility of a nonzero $f_{esc}$ given \textit{GALEX}/FUV detection (blended with 2 nearby sources) and we discuss the prospects of LyC escape for EELG1002 in \S\ref{sec:fesc}. All emission lines in the model have fixed observed FWHM set to $400$ km s$^{-1}$, consistent with our observations (Table \ref{table:line_fits}). $E(B-V)$ is fixed to 0 mag given \hbeta/\hgamma~(see Table \ref{table:ISM}).
	...
	\end{eqnarray}
	to measure the ionizing photon production rate, $Q_H$, with \hbeta~luminosity from our observed GMOS spectra. Given that Balmer Decrements show $E(B-V) \sim 0$ mag, we do not apply any dust correction.

	\subsection{Galaxy Size \& Dynamical Mass Measurement}
	\label{sec:dynamical_mass}
	
	We use archival \textit{HST} ACS/F814W to measure the rest-frame $\sim 4500$\AA~galaxy size. A single Sersic profile is assumed and fitted to the F814W image using \texttt{pysersic} \citep{Pasha2023}: a public package that uses Bayesian inference to fit Sersic profiles to galaxy images. We also assume a flat background around EELG1002 which is simultaneously fit during the Sersic profile fitting. Assumed priors are the default in \texttt{pysersic}. The effective/half-light radius, $r_{e}$, has a truncated normal prior centered at 3.52 pixels with $\sigma$ of 3.75 pixels and a minimum cutoff at 0.5 pixels. The Sersic index, $n$, is set to a uniform prior between 0.65 and 8. The posterior for both variables are measured using a No U-turn Sampler (NUTS, \citealt{Hoffman2014}) and are used to measure the uncertainties.
	
	The dynamical mass is measured based off the half-light radius and intrinsic velocity dispersion (\S\ref{sec:velocity_dispersion}) and traces all baryonic matter within the galaxy: stellar, gas, dust, and dark matter. Given that we have measurements of stellar mass from our SED fitting and that EELG1002 has relatively no dust (Table \ref{table:ISM}), the dynamical mass compared to the stellar mass provides a tracer of how much gas and dark matter resides within EELG1002. The dynamical mass is defines as:
	\begin{equation}
		M_{dyn} = C \frac{\sigma_{int}^2 r_e}{G}
		\label{eqn:dynamical_mass}
	\end{equation}
	where the scaling factor $C$ is dependent on the mass distribution and velocity field of the galaxy and could range from $C \sim 1$ -- 5 \citep{Erb2006}. We follow \citet{Maseda2013} which measured dynamical masses for EELG populations at $z \sim 2$ and assumed $C = 3$. However, we also incorporate the range of $C \sim 1$ -- $5$ in our uncertainties by uniformly sampling $C$ between $1$ and $5$ and measuring the dynamical mass. This provides for a conservative estimate on the possible range in dynamical mass. 
		...
		\begin{figure}
			...
			\caption{The rest-frame \oiii+\hbeta~EW -- stellar mass anti-correlation. EELG1002 is shown as a \textit{star} with \textit{dark blue} using \bagpipes~and \textit{light blue} for \cigale~for the continuum flux density in measuring \oiii+\hbeta~EW. We find EELG1002 is a uniquely `extreme' ELG with \oiii+\hbeta~EW $\sim 16$ -- $35\times$ higher compared to the typical \oiii$+$\hbeta~EW at $z \sim 0.8$ (\textit{blue line}; \citealt{Khostovan2016}) and somewhat higher than the typical EW at $z \sim 3$ -- $9$ \citep{Khostovan2016, Matthee2023, Boyett2024}. EELG1002 also has EW higher than Blueberries \citep{Yang2017_BB}, Green Peas \citep{Cardamone2009}, the $z \sim 2.5$ intense starburst BOSS-EUVLG1 \citep{Marques-Chaves2020}, and the $z \sim 3.2$ LyC emitter \textit{Ion2} \citep{deBarros2016}. EELG1002 is consistent with local LyC leakers \citep{Izotov2016,Izotov2018,Izotov2021} and we do discuss the potential of LyC escape further in this study. Overall, EELG1002 is a uniquely rare and `extreme' ELG with EWs somewhat more extreme than EoR-era galaxies.}
			\label{fig:EW}
		\end{figure}
		%EELG1002 is found to be $\sim 16$ -- 35$\times$ higher in EW$_0$(\oiii$+$\hbeta) relative to typical $z \sim 0.8$ ELGs (\textit{blue line}; \citealt{Khostovan2016
		EELG1002 ($\alpha = 10:00:32.304$, $\delta = +2:51:11.351$) is a uniquely low-mass, high EW emission line galaxy with numerous emission line detections, as shown in the top panel of Figure \ref{fig:spectra_and_sed}, that, in conjunction with the wealth of multi-wavelength ancillary photomerty, provides us a great deal of information in regards to its star-formation and ISM conditions. We present redshift, line flux, EW, and velocity dispersion measurements for each line in Table \ref{table:line_fits}. We find a spectroscopic redshift in the range of $z_{spec} \sim 0.8273$ and $0.8276$ depending on which line is used (\hbeta, \oiii5007\AA, and \neiii3869\AA). The discrepancies are well within $1\sigma$ error bars and could arise simply due to uncertainties within the wavelength calibration and limiting resolution of the GMOS R150 grating. Throughout this work, we quote the spectroscopic redshift as $z_{spec} \sim 0.8275$ which is the average of the three different measurements. 
		
		Figure \ref{fig:spectra_and_sed} shows all the multi-wavelength photometry associated with EELG1002 and our best-fit \cigale~and \bagpipes~SEDs. The photometry alone shows the presence of nebular emission line contribution in the narrowband, intermediate band, and broadband photometries (e.g., Subaru SuprimeCam and HSC $z$-band is dominated by the presence of \oiii+\hbeta) which would suggest high EW emission lines. \cigale~(\textit{green}) and \bagpipes~(\textit{red}) SEDs are for the most part consistent in showing strong nebular emission line features, but vary in several key areas. \cigale~shows a stronger inverse Balmer jump signifying the presence of young stellar populations while \bagpipes~also includes a similar feature but less extreme. Bluewards of the Balmer jump, we find that \bagpipes~measures a steeper rise in continuum flux densities compared to \cigale. We find that this is due to two factors: different assumed IMFs and assumed stellar populations. \cigale~assumes a single stellar population synthesis model \citep{Bruzual2003} and \cite{Chabrier2003} IMF. On the other hand, \bagpipes~includes the contribution of binary stellar populations (\texttt{BPASS}; \citealt{Stanway2018}) which would extend the lifetimes of young, massive, blue stars due to mass transfer resulting in elevated rest-frame UV fluxes. \bagpipes~also assumes a broken power law IMF that allows for increased numbers of $0.1 - 1$ \msol~stars compared to the exponential cutoff found at the same mass range in \cite{Chabrier2003} IMF. This, in conjunction with the extended lifetime of stars in a binary configuration, could explain the elevated continuum flux densities in \bagpipes~in comparison to \cigale. It also highlights how, as will be shown throughout this paper, EELG1002 is a unique case of how sensitive SED-derived measurements are on the choice of stellar population models and assumed IMFs.
		
		We find EELG1002 has a stellar mass of $(3.6^{+0.16}_{-0.09}) \times 10^7$ \msol~(\bagpipes) and $(1.14\pm0.44) \times 10^8$ \msol~(\cigale). Using the continuum fluxes as described in \S\ref{sec:measure_ew}, we find EELG1002 has significantly strong EWs as shown in Table \ref{table:line_fits}. The combined rest-frame \oiii+\hbeta~EW for EELG1002 is $2792^{+24}_{-22}$\AA~(\bagpipes) and $3697^{+31}_{-30}$\AA~(\cigale) which is significantly high for a $z \sim 0.8$ emission line galaxy. To understand how `extreme' EELG1002 is requires that we take this within the context of how elevated the \oiii+\hbeta~EW is in comparison to typical star-forming galaxies at the same stellar mass and redshift. Figure \ref{fig:EW} shows the typical EWs of emission line galaxies at a given stellar mass and redshift from $z \sim 0.8$ to $3.2$ measured from narrowband-selected \oiii~emitters \citep{Khostovan2016}. We find that EELG1002 lies 16 (\bagpipes) to 35 (\cigale) times above the typical \oiii+\hbeta~EWs at $z \sim 0.8$ placing this well above the typical range of EWs of star-forming galaxies at similar redshift and stellar mass.
		
		In the case of \cigale-measured continuum and stellar mass, EELG1002 is also `extreme' relative to typical $z \sim 3.2$ \citep{Khostovan2016} and even $z \sim 3$ -- 7 \oiii~emitters observed recently with \textit{JWST} via EIGER \citep{Matthee2023}  and JADES \citep{Boyett2024}. The \bagpipes-based EW measurement suggests EELG1002 is more consistent with typical \oiii~emitters at $z \sim 2 - 9$. Overall, both measurements provide evidence that EELG1002 may be, in terms of its EW and stellar mass, a uniquely placed analog of either typical (\bagpipes) or even perhaps extreme (\cigale) star-forming galaxies during the Epoch of Reionization.
		...
		Overall, EELG1002 has $\sim 16 - 35 \times$ higher \oiii+\hbeta~EW compared to the typical EW of a star-forming galaxy at similar stellar mass and redshift making it a potentially record-breaking system in this regard. It also has EWs at or larger than the typical EWs currently observed by high-$z$ studies with \textit{JWST}, depending on which SED model is used in determining the continuum, making it uniquely placed as an analog of high-$z$ galaxies and provides an opportunity given the wealth of emission lines detected in the GMOS spectra to investigate star-formation and ISM properties in great detail.
		...
		\begin{figure*}
			...
			\caption{BPT (\textit{left}) and MEx (\textit{right}) diagrams for SFG/AGN classification. \nii/\halpha~for EELG1002 is inferred assuming the \citet{Marino2013} calibration. EELG1002 is found to have \oiii/\hbeta~and \nii/\halpha~ratios well within BPT-SFG classification with a significant offset from the locus of star-forming galaxy populations at $z \sim 1.6$ (FMOS; \citealt{Kashino2019}), $z \sim 2$ (MOSDEF; \citealt{Kriek2015}), and $z \sim 5.5 - 9$ (JADES, \citealt{Cameron2023}). EELG1002 also has inferred \nii/\halpha~ratios well below $z < 1$ EELGs \citep{Amorin2015} and local LyC leakers \citep{Izotov2016,Izotov2018} and find it is more consistent with Extreme Metal Poor Galaxies (EMGPs; \citealt{Nishigaki2023}) although with higher \oiii/\hbeta. The MEx diagram also shows EELG1002 lies within the star-forming galaxy classification in the case of \bagpipes- and \cigale-measured stellar mass with similar \oiii/\hbeta~ratios compared to Blueberries \citep{Yang2017_BB} and Green Peas \citep{Yang2017_GP}. In both diagnostics, EELG1002 shows no evidence of an AGN component.}
			\label{fig:BPT_MEx}
		\end{figure*}
		...
		We first investigate the GMOS spectra for signatures of broad line emission that could be an indication of Type 1 AGN (`BL-AGN', FWHM $> 1000$ km s$^{-1}$; e.g., \citealt{Stirpe1990,Ho1997}). However, as shown in Figure \ref{fig:spectra_and_sed}, we find no evidence for a broad line component in any of the observed emission lines. Furthermore, the observed velocity dispersion reported in Table \ref{table:line_fits} range from 146 to 230 km s$^{-1}$ and correcting for instrumental resolution and thermal broadening reduces the velocity dispersion to between 53 and 150 km s$^{-1}$ which is well below the $> 1000$ km s$^{-1}$ FWHM typically observed in BL-AGN (e.g., \citealt{Genzel2014}).
		
		We also consider the possibility of a potentially strong ionizing radiation spectrum (see \S\ref{sec:ionization}) that could produce strong ionization lines such as [Ne{\sc v}]3426\AA~(requires $\sim 94$ eV) indicative of an AGN. However, we find no evidence within the GMOS spectra for the presence of [Ne{\sc v}] emission. We also inspect \textit{Chandra}-COSMOS \citep{Marchesi2016} and \textit{XMM} imaging (PI: G. Hasinger, \zzz) and find no hard and soft X-ray detections.
		
		We lastly use two popular star-forming/AGN classification diagnostics: Mass-Excitation diagram (MEx; \citealt{Juneau2011}) and BPT \citep{BPT}. MEx is very similar to BPT where instead of \nii/\halpha, the diagnostic uses the mass-metallicity relation traced via \nii/\halpha~to convert the BPT into a $R3$ -- stellar mass diagnostic. In our specific case, we do not have \nii/\halpha~and we instead infer this line ratio by converting our direct $T_e$ gas-phase metallicity to \nii/\halpha~using the \citet{Marino2013} calibration and its associated uncertainties. Figure \ref{fig:BPT_MEx} shows that EELG1002 lies entirely within the star-forming galaxy classification region using both BPT and MEx. 
		...
		As shown in the \textit{top} panel of Figure \ref{fig:spectra_and_sed}, EELG1002 has strong \oiii5007\AA~emission with $\sim (9.2 \pm0.7) \times 10^{-16}$ \cgsline~in line flux and moderate \oii~emission (Table \ref{table:line_fits}) with a measured O32 ratio of $11.14^{+0.61}_{-0.58}$ indicative of energetic conditions (see \S\ref{sec:ionization}). Based on our spectrophotometric SED fitting described in \S\ref{sec:SED}, we find ionization parameters of $\log_{10} U = -2.23 \pm 0.06$ (\cigale) and $-1.64^{+0.11}_{-0.12}$ (\bagpipes) as shown in Table \ref{table:ISM}. We also independently measure $U$ using only the GMOS spectra with \texttt{HCM} assuming \texttt{BPASS} and a single 1 Myr burst of star formation and similar IMF to what was used in \texttt{Bagpipes} and find a similar $\log_{10} U = -1.69\pm0.12$. The discrepancy between \cigale~vs \bagpipes~and \texttt{HCM} is most likely attributed to the inclusion of binary populations via \texttt{BPASS} where young hot, massive stars live for longer periods of time allowing for harder ionizing spectra. 
		
		Qualitatively, both \cigale~and \bagpipes~suggests EELG1002 has ionization parameters that would suggest highly energetic conditions within the ISM and also highlights how $U$ is sensitive to the assumed stellar population model (e.g., single vs binary systems). The energetic ionization state is aided by the low metallicity conditions described in \S\ref{sec:metallicity} where essentially the number of metal coolants is quite low allowing for higher gas temperatures as we found using \oiii4363\AA~($T_e \sim 19500$ K; Table \ref{table:ISM}). EELG1002 also has $n_e = 488^{+340}_{-247}$ cm$^{-3}$ which is higher than typical electron densities at similar redshift ($\sim 20 - 100$ cm$^{-3}$; e.g., \citealt{Kaasinen2017,Swinbank2019, Davies2021}) and is consistent with $z > 5$ galaxies ($> 200$ cm$^{-3}$; e.g., \citealt{Isobe2023}). Based on Equation \ref{eqn:logU}, this would suggest for harder ionizing radiation spectrum where elevated levels of hydrogen ionizing photons are produced. 
		...
		In previous sections, we find EELG1002 is characterized as having a highly energetic ISM with ionization parameters of $\log_{10} U = -2.23\pm0.06$ (\cigale) and $-1.64^{+0.11}_{-0.12}$ (\bagpipes) and a hard ionizing radiation field favoring both O$^{++}$ and Ne$^{++}$. Measurements of $n_e$ and $T_e$ in conjunction with the ionization parameter, as defined in Equation \ref{eqn:logU}, also show favorable conditions for increased ionizing photon production which, based on our results in \S\ref{sec:AGN}, is attributed to star-formation processes. We report measurements of the ionizing photon production efficiency and $1500$ \AA~magnitudes in Table \ref{table:SED} where we find EELG1002 has $\log_{10}\textrm{\xiionHtwo} = 25.74\pm0.03$ (\cigale) and $25.70\pm0.02$ with $M_{UV} = -19.34\pm0.06$ (\cigale) and $-19.44\pm0.02$ mag (\bagpipes). Despite the different IMF and stellar population models assumed in \cigale~and \bagpipes, both have \xiion~within $1\sigma$ agreement of each other which highlights how both independent SED fitting suites are suggesting EELG1002 is dominated by a young stellar population.
		...
		The ISM and ionization properties of EELG1002 suggest a stellar population that is dominated by young, massive stars capable of producing large quantities of ionizing photons and harder ionizing radiation spectrum. This also indicates that EELG1002 is undergoing a recent, rapid increase/burst of star formation activity. As described in \S\ref{sec:SED}, we explore both parametric (delayed-$\tau$ + recent burst; \cigale) and non-parametric (\bagpipes) star formation history modeling in our SED fitting. 
		
		
		Table \ref{table:SED} shows SFRs measured on different timescales where we find that both \cigale~and \bagpipes~measure about an order-of-magnitude increase in the SFRs from 100 to 10 Myrs. Despite the different modeling used, we find that both parametric and non-parametric SFH models are consistent with 100 Myr SFRs of $\sim 0.3$ -- $0.4$ \msol~yr$^{-1}$ and a rapidly increasing SFH reaching 10 Myr SFRs of $\sim 2.5$ -- $3.2$ \msol~yr$^{-1}$. Only \cigale~measures a 1 Myr SFR of $22.33\pm4.35$ \msol~yr$^{-1}$ as this is the default minimum time resolution in its SFH modeling, while \bagpipes~non-parametric SFH has a minimum time resolution of 3 Myr (see \S\ref{sec:bagpipes}). The \hbeta~SFR is measured using \cite{Kennicutt1998} calibration assuming \cite{Chabrier2003} IMF and found to be $7.7\pm0.4$ \msol~yr$^{-1}$. This is consistent with the \cigale~SFR as the timescales traced by \hbeta~(depending on the stellar population model) is $\sim 1 - 10$ Myr. Overall, the SFRs suggest for an intense, rapidly increasing burst of star-formation activity in recent times.
		
		For a low-mass galaxy such as EELG1002, a high SFR would be indicative of high specific SFR (sSFR)  placing it well above the SFR -- stellar mass correlation (`starburst'; e.g., \citealt{Speagle2014}). Table \ref{table:SED} includes the sSFR measured on 1, 10, and 100 Myr timescales along with \hbeta-measured sSFR assuming both the stellar mass measured from \cigale~and \bagpipes. As we saw for the SFRs, the sSFR also increases an order-of-magnitude from 100 to 10 Myr as well as from 10 to 1 Myr in the case of \cigale. We also find \hbeta-measured sSFR of $67.5\pm26$ Gyr$^{-1}$ (\cigale) and $214^{+14}_{-12}$ Gyr$^{-1}$ (\bagpipes) which would mean mass doubling times (inverse of the sSFR) $\sim  5$ -- $15$ Myr. This suggests that not only is EELG1002 undergoing a rapid burst of star formation activity, but is also rapidly building up its stellar mass content. 
		...
		\begin{figure}
			...
			\caption{Illustris Analogs of EELG1002 with their respective star formation (\textit{top}), stellar and gas mass (\textit{middle}), and chemical enrichment (\textit{bottom}) histories. Both analogs show a rapid increase in star formation activity occurring at $z \sim 0.8$ signifying a first starburst phase where both are chemically unevolved and supported by high gas masses. Rapid chemical enrichment and stellar mass buildup occurs within 100 -- 250 Myrs. Subsequent histories past $z < 0.7$ are different between both analogs owing to various mergers; however, both eventually become $10^{10 - 11}$ \msol~galaxies with solar-level metallicities. Therefore, EELG1002-like sources may potentially merge with more massive systems to become large structures in the local Universe. However, if EELG1002 remains isolated, then it could be the progenitor of a massive, compact quiescent galaxies (e.g., \citealt{Barro2013,Zolotov2015}).}
			\label{fig:analogs}
		\end{figure}
		...
		\begin{enumerate}[nolistsep,label=(\roman*)]
			\item EELG1002 has rest-frame \oiii+\hbeta~EW $\sim 2800$ to $3700$\AA~with stellar mass of $\sim 10^7$ to $10^8$ \msol~depending on the SED fitting model assumed for the continuum flux density. This is found to be $\sim 16 - 35 \times$ higher than the typical \oiii+\hbeta~EW for $z \sim 0.8$ at similar stellar mass outlining the extremity and rarity of such a source. The \oiii+\hbeta~EW is also higher than typical $z > 3$ ELGs  \citep{Khostovan2016,Boyett2024} and even $z \sim 5 - 7$ galaxies \citep{Matthee2023} and comparable to known local LyC leakers.
			
			\item Strong \hbeta~emission suggests recent star formation rates of $7.7$ \msol~yr$^{-1}$ with mass doubling timescales of $\sim 5 - 15$ Myr. Combined with its compact size ($r_{eff} \sim 530$ pc; proper), we find EELG1002 has $\Sigma_{SFR} \sim 4.4$ \msol~yr$^{-1}$ kpc$^{-2}$. Star formation history modeling using spectrophotometric SED fitting (\cigale~and \bagpipes) also confirms the bursty star-forming nature of EELG1002 with no past star-formation activity at older lookback times.
						
			\item We find no clear evidence of an AGN component in EELG1002 given the lack of broad emission line features, X-ray detection, and the necessary \oiii/\hbeta, stellar mass, and \nii/\halpha~(inferred) to fall within the AGN classification using MEx and BPT diagnostics. There may be a potential obscured AGN component given \textit{Spitzer}/IRAC photometry; however, it is blended with 2 nearby sources. Furthermore, a dust obscured AGN may be unlikely given that Balmer Decrements suggest $E(B-V) = 0$ mag.
			
			\item We find EELG1002 is metal poor with $12+\log_{10} (\textrm{O/H}) = 7.51\pm0.07$ ($Z_{gas} = 0.066^{+0.011}_{-0.009}$ \zsol) based on direct $T_e$ measurements using the auroral \oiii4363\AA~line. At the measured stellar mass, we find EELG1002 has gas-phase metallicity consistent with $z > 5$ galaxies. Other known low-$z$ analogs of high-$z$ galaxies show higher stellar mass and metallicity compared to EELG1002 which would suggest some past star-formation activity and chemical enrichment. However, the low metallicity and stellar mass of EELG1002 suggests a lack of chemical evolution and past star-formation activity such that EELG1002 may represent a galaxy undergoing a potential first bursty phase of star formation.
			
			\item Spectrophotometric SED fitting using both \cigale~and \bagpipes~show elevated ionization parameters with $\log_{10} U \sim -2.2$ and $-1.6$, respectively, with the discrepancy due to variations in assumed IMF and stellar population models. \oiii/\oii~ratios also suggest highly energetic ISM conditions and elevated \neiii/\oii~at fixed \oiii/\oii~show evidence of a harder ionizing radiation field (e.g., more EUV photons).  The lack of \heii4686\AA~emission is due to the observations not going deep enough to detect the line rather than an upper limit in the ionizing spectrum at 54 eV. Deep rest-frame UV spectroscopic follow-up could potentially yield \heii1640\AA~which is typically $\sim 6 - 8 \times$ brighter than its 4686\AA~counterpart.
			
			\item EELG1002 has $\log_{10} \textrm{\xiion} \sim 25.70 - 25.75$ that is consistent with some of the most extreme and bursty star-forming galaxies observed at $z > 7$ based on \oiii+\hbeta~EW and sSFR. The elevated efficiency in producing ionizing photons within EELG1002 may be attributed to a combination of elevated SFR, compact size, low metallicity, and highly energetic ISM condition with evidence of a harder ionizing radiation field. 
		...
		AAK thanks Brian Lemaux, Keunho Kim, Mainak Singha, and Ryan Sanders for useful discussions. AAK also thanks all participants of the First Gigayear(s) Conference at Hilo for productive comments and discussions. %AAK thanks Brian Lemaux for checking EELG1002's position within their 3D large-scale structure maps.
		...
		\begin{table*}
			\caption{\bagpipes~parameters used in the SED fitting process}
			...
			\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}lcc}
				...
				\hline
				\textbf{Nebular Emission Line Spectrum} (\texttt{Cloudy v17.03}) & & \\
