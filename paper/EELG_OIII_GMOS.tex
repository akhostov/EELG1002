...
%% the \begin{document} command.
	...
	\subsection{What becomes of sources like EELG1002?}
		...
		AAK thanks Yuichi Harikane, Erini Lambrides, Brian Lemaux, Keunho Kim, Jed McKinney, Mainak Singha, and Ryan Sanders for useful discussions. AAK also thanks all participants of the First Gigayear(s) Conference at Hilo, Hawaii and the STScI Spring Symposium 2024 for productive comments, feedback, and discussions. %AAK thanks Brian Lemaux for checking EELG1002's position within their 3D large-scale structure maps.
